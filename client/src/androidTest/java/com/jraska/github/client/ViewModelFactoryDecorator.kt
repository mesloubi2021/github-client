...
class ViewModelFactoryDecorator(private val decoratedFactory: ViewModelProvider.Factory,
  ...
  companion object {
    fun setToApp(viewModelClass: Class<out ViewModel>,
    ...
    private fun setToApp(app: GitHubClientApp,
                         viewModelClass: Class<out ViewModel>, implementation: ViewModel) {
